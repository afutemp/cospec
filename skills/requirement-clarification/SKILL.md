...
description: Use when helping product planning clarify a product requirement before writing a user requirements document
---

# Product Planning Requirement Clarification

**Skill 标识**: `requirement-clarification`

其他 skill 通过 `requirement-clarification` 引用本 skill。
...
| `config.evaluators["requirement-clarification"]` | Evaluator skill name after this stage; `false` = disable gate |
