...
cospec skills override default system prompt behavior, but **user instructions always take precedence**:

1. **User's explicit instructions** (CLAUDE.md, direct requests) -- highest priority
2. **cospec skills** -- override default system behavior where they conflict
...
Skills use Claude Code tool names. Non-CC platforms: refer to your platform's documentation for skill loading mechanisms.
...
Instructions say WHAT, not HOW. "Clarify this requirement" or "Write a TR1" doesn't mean skip workflows.
