...
|--------|-------------|-----------|
| [cospec](./plugins/cospec) | AI-native product planning workflow: requirement clarification, user journey design, TR1/TR2 artifacts, and confirmed Frieren Demo handoff. | Claude Code, Codex, Cursor |
